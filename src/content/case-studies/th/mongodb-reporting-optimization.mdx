...
endDate: 2025-12-12
metaTitle: "เพิ่มประสิทธิภาพ MongoDB Reporting"
metaDescription: "ปรับ aggregation, index design และ pagination ของระบบ reporting campaign ปริมาณมาก — แก้ slow query และงานที่กิน memory หนักให้ scale ได้"
---
...
<figure data-reveal class="my-2 rounded-lg border border-line-soft bg-ink-900/40 p-5 sm:p-6 stage-nodes">
  ...
  <figcaption class="mt-4 text-center font-mono text-xs text-dim">
    query เดิม แต่จัดใหม่: pipeline ที่ align กับ index อ่านเฉพาะที่ต้องคืน — latency ขึ้นกับขนาดผลลัพธ์ ไม่ใช่ปริมาณ history ที่สะสม
  </figcaption>
</figure>
