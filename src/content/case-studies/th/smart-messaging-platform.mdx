...
metaTitle: "ระบบ Smart Messaging Platform"
metaDescription: "แพลตฟอร์ม campaign messaging ระดับ enterprise — validate ผู้รับ, ตั้งเวลา, ส่ง และ reporting ประมวลผลได้ถึง 1,000,000 record ด้วย NestJS และ MongoDB"
---
