...
metaDescription: "Enterprise campaign messaging platform — recipient validation, scheduling, delivery, and reporting — processing up to 1,000,000 records on NestJS and MongoDB."
---
...
<figure data-reveal class="my-2 rounded-lg border border-line-soft bg-ink-900/40 p-5 sm:p-6 stage-nodes">
  ...
  <figcaption class="mt-4 text-center font-mono text-xs text-dim">
    One validation pipeline for every input · memory-flat batched delivery · MongoDB-backed reporting
  </figcaption>
</figure>
