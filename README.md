...
Bilingual (EN / TH) personal portfolio for a senior backend engineer.
Built with **Astro 5 + TypeScript + Tailwind CSS 4 + MDX**, fully static, dark-mode-first.
...
```
src/
  components/        # 21 reusable components (+ pages/ = per-page templates)
